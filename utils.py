...
# Define user_goal_prompt directly here
user_goal_prompt = "Please provide a detailed learning path for the user's goal."
...
async def setup_agent_with_tools(
    ...
    try:
        ...
        if not youtube_pipedream_url:
            raise ValueError("YouTube Pipedream URL is required.")
